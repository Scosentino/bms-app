Rails.application.routes.draw do
  ...
  patch 'update_admin_navbar_logo', to: 'admins#update_logo', as: :update_navbar_logo
  ...
  patch 'update_customer_navbar_logo', to: 'customers#update_logo', as: :update_customer_navbar_logo
